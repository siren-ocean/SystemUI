...
public class FilterAttribute {
    ...
    private final static String PHONE = "product=\"phone\"";
    ...
    private static boolean matchAttribute(String content) {
        String regex = ".*(" + TABLET + ")|(" + DEVICE + ")|(" + NOSDCARD + ")|(" + EMULATOR + ")|(" + TV + ")|(" + PHONE + ").*";
     ...
     * 清除带标签的行
     */
    public static void eliminate(File file, String label) {
        String content = readFileToStr(file);
        List<String> filterList = getFieldListByRegex(content, label);
