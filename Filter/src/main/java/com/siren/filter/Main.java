...
public class Main {
    ...
    private static void replaceContent() {
        FileContentReplacer.replaceInPath("res/drawable/", "\"?androidprv:attr/colorSurface\"", "\"@android:color/transparent\"");
        ...
        FileContentReplacer.replaceInPath("res/values/styles.xml", "<style name=\"ScrollableAlertDialogStyle\" parent=\"@androidprv:style/AlertDialog.DeviceDefault\">", "<style name=\"ScrollableAlertDialogStyle\" parent=\"@*android:style/AlertDialog.DeviceDefault\">");
        FileContentReplacer.replaceInPath("res/values/styles.xml", "<style name=\"ButtonBarStyle\" parent=\"@androidprv:style/DeviceDefault.ButtonBar.AlertDialog\">", "<style name=\"ButtonBarStyle\" parent=\"@*android:style/DeviceDefault.ButtonBar.AlertDialog\">");
        ...
        FileContentReplacer.replaceInPath("res-keyguard/values/styles.xml", "<item name=\"android:textColor\">?androidprv:attr/textColorOnAccent</item>", "<item name=\"android:textColor\">@*android:attr/textColorOnAccent</item>");
    }
}
