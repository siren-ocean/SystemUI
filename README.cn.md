...
## SystemUI from android-13.0.0_r31
...
###  在pixel4运行效果
---
<img src="images/pixel4_systemui_gradle.png" width = "300"/>
...
##### @core-all.jar:
```
// android-13/out/soong/.intermediates/libcore/core-all/android_common/javac/core-all.jar
...
##### @core-icu4j.jar:
```
// android-13/out/soong/.intermediates/external/icu/android_icu4j/core-icu4j/android_common/javac/core-icu4j.jar
...
##### @protolog-lib.jar:
```
// android-13/out/soong/.intermediates/frameworks/base/core/java/protolog-lib/android_common/javac/protolog-lib.jar
...
```
// android-13/out/soong/.intermediates/frameworks/base/libs/WindowManager/Shell/WindowManager-Shell-proto/android_common/javac/WindowManager-Shell-proto.jar
...
##### @zxing-core-1.7.jar:
```
// android-13/out/soong/.intermediates/external/zxing/core/zxing-core-1.7/android_common/combined/zxing-core-1.7.jar
...
##### @SystemUI-proto.jar:
```
// android-13/out/soong/.intermediates/frameworks/base/packages/SystemUI/SystemUI-proto/android_common/javac/SystemUI-proto.jar
...
##### @SystemUI-statsd.jar:
```
// android-13/out/soong/.intermediates/frameworks/base/packages/SystemUI/shared/SystemUI-statsd/android_common/javac/SystemUI-statsd.jar
...
##### @SystemUI-tags.jar:
```
// android-13/out/soong/.intermediates/frameworks/base/packages/SystemUI/SystemUI-tags/android_common/javac/SystemUI-tags.jar
...
```
// android-13/prebuilts/sdk/current/androidx/m2repository/androidx/preference/preference/1.2.0-alpha01/preference-1.2.0-alpha01.aar
...
```
// android-13/prebuilts/sdk/current/androidx/m2repository/androidx/dynamicanimation/dynamicanimation/1.1.0-alpha04/dynamicanimation-1.1.0-alpha04.aar
...
##### @WifiTrackerLib: 
```
// android-13/frameworks/opt/net/wifi/libs/WifiTrackerLib
...
##### @Shell: 
```
// android-13/frameworks/base/libs/WindowManager/Shell
...
##### @setupcompat: 
```
// android-13/external/setupcompat
...
##### @setupdesign: 
```
// android-13/external/setupdesign
...
在AOSP/android-13/build/target/product/security路径下找到签名证书，并使用 [keytool-importkeypair](https://github.com/getfatday/keytool-importkeypair) 生成keystore,
执行如下命令：
